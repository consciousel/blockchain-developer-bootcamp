	...
	return(
		<div>
			<form className="row" onSubmit={(event) => {
				...
				<div className="col-12 col-sm-6 pl-sm-10">
					<button 
					type="submit"
		...
		return (
			<div className="card bg-dark text-white">
				...
				<div className="card-body">
					{this.props.showForm ? showForm(this.props) : this.props.refreshOrderForms ? refreshOrderForms(this.props) : <Spinner />}
				</div>
			</div>
		)
	}
...
function mapStateToProps(state) {
	...
	return {
		...
		refreshOrderForms: !(buyOrder.making == sellOrder.making),
