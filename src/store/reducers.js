...
function exchange(state = {}, action) {
	...
	switch (action.type) {
		...
		case 'BUY_ORDER_MADE':
			return { ...state, buyOrder: { ...state.buyOrder, amount: null, price: null, making: false } }
		...
		case 'SELL_ORDER_MADE':
			return { ...state, sellOrder: { ...state.sellOrder, amount: null, price: null, making: false } }
