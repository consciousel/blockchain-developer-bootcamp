...
export function balancesReloading(balance) {
	return {
		type: 'BALANCES_RELOADING' ,
		balance
	}
}
...
export function buyOrderMade(price) {
	return {
		type: 'BUY_ORDER_MADE',
		price
	}
...
export function sellOrderMade(price) {
	return {
		type: 'SELL_ORDER_MADE'
	}
}